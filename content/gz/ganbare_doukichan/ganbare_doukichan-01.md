...
aliases : [
    ...
    '/gz/ganbare douki chan01/',
    '/gz/ganbare douki chan1/',
    '/gz/ganbare douki chan1x01/',
    '/gz/ganbare douki-chan/01/',
    '/gz/ganbare douki-chan/1/',
    '/gz/ganbare douki-chan/1x01/',
    '/gz/ganbare douki-chan01/',
    ...
    '/gz/ganbare douki_chan01/',
    '/gz/ganbare douki_chan1/',
    '/gz/ganbare douki_chan1x01/',
    '/gz/ganbare doukichan/01/',
    '/gz/ganbare doukichan/1/',
    '/gz/ganbare doukichan/1x01/',
    '/gz/ganbare doukichan01/',
    '/gz/ganbare doukichan1/',
    '/gz/ganbare doukichan1x01/',
    '/gz/ganbare-douki chan/01/',
    '/gz/ganbare-douki chan/1/',
    '/gz/ganbare-douki chan/1x01/',
    '/gz/ganbare-douki chan01/',
    ...
    '/gz/ganbare_douki chan01/',
    '/gz/ganbare_douki chan1/',
    '/gz/ganbare_douki chan1x01/',
    '/gz/ganbare_douki-chan/01/',
    '/gz/ganbare_douki-chan/1/',
    '/gz/ganbare_douki-chan/1x01/',
    '/gz/ganbare_douki-chan01/',
    ...
    '/gz/ganbare_douki_chan01/',
    '/gz/ganbare_douki_chan1/',
    '/gz/ganbare_douki_chan1x01/',
    '/gz/ganbare_doukichan/01/',
    '/gz/ganbare_doukichan/1/',
    '/gz/ganbare_doukichan/1x01/',
    '/gz/ganbare_doukichan01/',
    '/gz/ganbare_doukichan1/',
    '/gz/ganbare_doukichan1x01/',
    '/gz/ganbaredouki chan/01/',
    '/gz/ganbaredouki chan/1/',
    '/gz/ganbaredouki chan/1x01/',
    '/gz/ganbaredouki chan01/',
    '/gz/ganbaredouki chan1/',
    '/gz/ganbaredouki chan1x01/',
    '/gz/ganbaredouki-chan/01/',
    '/gz/ganbaredouki-chan/1/',
    '/gz/ganbaredouki-chan/1x01/',
    '/gz/ganbaredouki-chan01/',
    ...
    '/gz/ganbaredouki_chan01/',
    '/gz/ganbaredouki_chan1/',
    '/gz/ganbaredouki_chan1x01/',
    '/gz/ganbaredoukichan/01/',
    '/gz/ganbaredoukichan/1/',
    '/gz/ganbaredoukichan/1x01/',
    '/gz/ganbaredoukichan01/',
    '/gz/ganbaredoukichan1/',
    '/gz/ganbaredoukichan1x01/',
]
...
<img style="width: 100%; border: 3px solid currentColor" title="Ganbare Douki-chan" alt="Ganbare Douki-chan" src="https://www.themoviedb.org/t/p/original/hzh8HhZ1j5mfBj796LcNSg7clse.jpg">

<br>

<div style="float: right">
{{< icona alto="30" tipo="maior" ligazon="/gz/ganbare-doukichan/02/" >}}
</div>
...
{{< sub alto="50" titulo="Debido a un erro no hotel, dous colegas acaban compartindo unha habitación nunha viaxe de trabalho" ligazon="/sub/ganbare_doukichan/ganbare_doukichan-01.gz.ass" autor="Fansubgalego" >}}
